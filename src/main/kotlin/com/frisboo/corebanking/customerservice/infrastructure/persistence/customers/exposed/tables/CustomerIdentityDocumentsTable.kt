...
internal class CustomerIdentityDocumentsTable(
    name: String,
    ...
    val identityDocumentId: Column<UUID> = uuid("id").autoGenerate()
    ...
    override val primaryKey: PrimaryKey =
        PrimaryKey(arrayOf(identityDocumentId, customerId), name = "pk_customer_identity_documents")
}
