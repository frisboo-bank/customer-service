...
internal class CustomerEmailsTable(
    name: String,
    ...
    val emailId: Column<UUID> = uuid("id").autoGenerate()
    val customerId: Column<UUID> = uuid("customer_id").references(customersTable.customerId)

    val email: Column<String> = varchar("email", length = EMAIL_MAX_LENGTH)
    ...
    override val primaryKey: PrimaryKey = PrimaryKey(emailId, name = "pk_customer_emails")
}
