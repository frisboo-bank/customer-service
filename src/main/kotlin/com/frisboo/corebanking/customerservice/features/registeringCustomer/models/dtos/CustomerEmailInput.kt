...
import com.frisboo.corebanking.customerservice.models.RegisterCustomerRequestEmailsInnerDto

fun RegisterCustomerRequestEmailsInnerDto.toEmail(): CustomerEmail =
    CustomerEmail(
        email = email,
